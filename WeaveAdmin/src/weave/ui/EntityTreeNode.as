...
package weave.ui
{
    ...
    public class EntityTreeNode extends EventDispatcher
    {
        ...
        public function commit(pubDiff:Object, privDiff:Object):AsyncToken
        {
			var em:EntityMetadata = new EntityMetadata
			em.publicMetadata = pubDiff;
			em.privateMetadata = privDiff;
            return AdminInterface.instance.meta_cache.update_metadata_and_fetch(id, em);
        }
